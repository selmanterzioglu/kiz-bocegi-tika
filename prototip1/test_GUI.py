...
class kiz_UI(Structure_Ui_Camera):
    ...
    def autonomous_Camera_Instance(self):
        ...
        self.cameras["camera_1"].api_CV2_Camera_Create_Instance(self.available_cameras[0], extra_params = []),
    ...
    def im_show(self, snapshot, camera_name):
